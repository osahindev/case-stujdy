...
import { newVariantData } from '../../../redux/slices/variant/thunks/newVariantData';
...
export default function NewDataModal() {
    ...
    return (
        <Modal title="Yeni Veri Formu" isOpen={newModelOpen} setOpen={() => dispatch(setNewModalOpen(false))} footer={
            <>
                <ButtonDark onClick={() => {
                    if (selectedVariant !== null)
                        dispatch(newVariantData({ attribute_id: selectedVariant?.id, value: name }));
                }}>
                    EKLE
                </ButtonDark>
